                            ...
                            <tr><td >1. <input type="radio" name="answer" value="DennisRitchie" <?php if ((strcmp($_SESSION['q2status'], "review") == 0 || strcmp($_SESSION['q2status'], "answered") == 0) && strcmp($_SESSION['q2stdans'], "DennisRitchie") == 0) {
                                ...
                                echo "checked";
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:8%;"><h4><input type="submit" name="summary" value="Summary" class="subbtn" /></h4></th>
                                    </tr>
                            ...
                            <div class="tc">
                                ...
                                echo "checked";
                                    ...
                                    <tr>
                                        ...
                                        <th style="width:8%;"><h4><input type="submit" name="fsum" value="Summary" class="subbtn" /></h4></th>
                                    </tr>
